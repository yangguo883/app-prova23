...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setError('');
    try {
      // Chiamata all'endpoint per impostare il CSRF cookie: qui NON va il prefisso "api/"
      await api.get('sanctum/csrf-cookie');

      // Ora chiama l'endpoint di registrazione (qui si aggiunge manualmente il prefisso "api/")
